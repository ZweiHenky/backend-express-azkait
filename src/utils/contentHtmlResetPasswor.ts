...
export const contentHtmlResetPassword = (verificationUrl:string) =>{
    const htmlTemplate = `
<!DOCTYPE html>
        <html lang="es">
        <head>
            ...
            <tr>
                <td align="center">
                    ...
                    <td style="padding: 32px 24px; color:#374151; font-size:16px;">
                        ...
                        <p style="margin:0 0 16px;">Hemos recibido una solicitud para restablecer la contraseña de tu cuenta de Azkait.</p>
                        <p style="margin:0 0 16px;">Para crear una nueva contraseña, por favor haz clic en el botón de abajo:</p>
                        <p style="text-align: center; margin: 24px 0;">
                        <a href="\${verificationUrl}" style="background-color:#f97316; color:#ffffff; text-decoration:none; padding:12px 24px; border-radius:9999px; display:inline-block; font-weight:500;">Cambiar contraseña</a>
                        </p>
                        <p style="margin:0 0 16px;">Si no solicitaste este cambio de contraseña, por favor ignora este correo. Tu contraseña actual permanecerá sin cambios.</p>
                        <p style="margin:0 0 16px;">Si tienes alguna pregunta o necesitas ayuda, no dudes en contactarnos.</p>
