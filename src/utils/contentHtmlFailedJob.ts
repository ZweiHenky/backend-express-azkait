...
export const contentHtmlFailedJob = () =>{
    const htmlTemplate = `
<!DOCTYPE html>
        <html lang="es">
        <head>
                ...
                <td align="center">
                    ...
                    <td style="padding: 32px 24px; color:#374151; font-size:16px;">
                        ...
                        <p style="margin:0 0 16px;">
                          Hemos revisado tu vacante y, por ahora, <span style="color: #2563eb;">no ha sido aprobada para su publicación.</span>
                          Detectamos algunos puntos que necesitan ser ajustados para cumplir con los estándares de calidad de la plataforma.
                        </p>

                        <p style="margin:0 0 16px;">
                          Estamos aquí para ayudarte.
                          Gracias por ser parte de Azkait.
                        </p>
