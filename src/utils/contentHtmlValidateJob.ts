...
export const contentHtmlValidatejob = () =>{
    const htmlTemplate = `
<!DOCTYPE html>
        <html lang="es">
        <head>
                ...
                <td align="center">
                    ...
                    <td style="padding: 32px 24px; color:#374151; font-size:16px;">
                        ...
                        <p style="margin:0 0 16px;">
                          ¡Gracias por confiar en Azkait! Tu vacante ha sido <span style="color: #2563eb;">cargada con éxito</span> en nuestra plataforma y ahora está siendo revisada por nuestro equipo.
                        </p>
                        <p style="margin:0 0 16px; color: #2563eb;">
                          🔎 ¿Qué sigue?
                        </p>
                        <p style="margin:0 0 16px;">
                          Realizaremos una validación rápida para asegurarnos de que la oferta cumpla con nuestros estándares de calidad y visibilidad. Este proceso no tomará más de <span style="color: #2563eb;">20 minutos.</span>
                        </p>
                        <p style="margin:0 0 16px;">
                          En cuanto esté lista, te notificaremos si fue <span style="color: #2563eb;">aprobada o si requiere ajustes.</span>
                        </p>
                        <p style="margin:0 0 8px;">Gracias por ser parte de la comunidad que está transformando el talento tech en LATAM.</p>
